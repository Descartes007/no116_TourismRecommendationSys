...
<div>
  <el-dialog 
      ...
      <div class="form-section">
        ...
        <el-form-item prop="image" class="upload-container">
          <el-upload
            ...
            <div class="upload-tip" slot="tip">点击上传轮播图片，只能上传jpg/png格式文件</div>
          </el-upload>
        </el-form-item>
      </div>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button size="small" type="primary" @click="submit" :loading="submitting">确 定</el-button>
    </div>
  </el-dialog>
</div>
</template>
...
<script>
  ...
  import {saveSysRotations} from '../../../api/api'
  export default {
    mixins: [mixin],
    data() {
      return{
      ...
      submit() {
        this.$refs["ruleForm"].validate((valid) => {
          if (valid) {
            ...
            saveSysRotations(this.form).then(res => {
