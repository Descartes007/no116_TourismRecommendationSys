...
//启用/禁用旅游线路
export const toggleSysLineState = (params) => get("/line/toggleSysLineState", params)

//-------------------------------旅游线路订单---------------------------------------
//查询旅游线路订单
export const getSysLineOrderPage = (params) => post("/lineOrder/getSysLineOrderPage", params)
//根据id查询旅游线路订单
export const getSysLineOrderById = (params) => get("/lineOrder/getSysLineOrderById", params)
//更新旅游线路订单状态
export const updateSysLineOrderState = (params) => post("/lineOrder/updateSysLineOrderState", params)
//取消旅游线路订单
export const cancelSysLineOrder = (params) => post("/lineOrder/cancelSysLineOrder", params)
