      ...
      <div class="search-table-container">
        ...
        <div class="table-panel">
            <div class="table-toolbar">
                <el-button type="primary" size="small" icon="el-icon-plus" @click="add">新增酒店</el-button>
                <el-button 
                    type="success" 
                    size="small" 
                    icon="el-icon-edit" 
                    :disabled="update.length !== 1" 
                    @click="updateDataBtn">编辑酒店</el-button>
                <el-button 
                    type="danger" 
                    size="small" 
                    icon="el-icon-delete" 
                    :disabled="update.length <= 0" 
                    @click="deleteDataBtn">删除酒店</el-button>
            </div>
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <div class="action-buttons">
                      ...
                      <el-button size="mini" type="info" plain @click="toItem(scope.row.id)">房型</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteDate(ids) {
        removeSysHotel({ids:ids}).then(res => {
            if(res.code == 1000) {
              this.$message({
                type: 'success',
                message: '删除成功!'
...
.table-toolbar {
  <mcfile name="line.vue" path="d:\旅游推荐系统\旅游推荐系统\源代码\admin-frontend\src\views\system\line\line.vue"></mcfile>
  .el-button {
    &.el-button--primary {
      background-color: #409eff;
      border-color: #409eff;
