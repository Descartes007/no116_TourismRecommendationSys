      ...
      <div class="search-table-container">
        ...
        <div class="table-panel">
            <div class="table-toolbar">
                <el-button type="primary" size="small" icon="el-icon-plus" @click="add">新增资讯</el-button>
                <el-button 
                    type="success" 
                    size="small" 
                    icon="el-icon-edit" 
                    :disabled="update.length !== 1" 
                    @click="updateDataBtn">编辑资讯</el-button>
                <el-button 
                    type="danger" 
                    size="small" 
                    icon="el-icon-delete" 
                    :disabled="update.length <= 0" 
                    @click="deleteDataBtn">删除资讯</el-button>
            </div>
...
<script>
  import {getSysForumPage,removeSysForum} from '../../../api/api' 
  ...
  export default {
    ...
    methods: {
      ...
      deleteDate(ids) {
        removeSysForum({ids:ids}).then(res => {
            if(res.code == 1000) {
              this.$message({
                type: 'success',
                message: '删除成功!'
