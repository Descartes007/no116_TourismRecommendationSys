            ...
            <el-row :gutter="20" class="search-row">
                <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
                    <div class="search-item">
                        <span class="search-label">景点名称:</span>
                    <el-input
                            size="small"
                            placeholder="请输入景点名称"
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                    <div class="action-buttons">
                      <el-button size="mini" type="success" plain icon="el-icon-check" @click="editSysAttractionOrder(scope.row.id,5)">标记已使用</el-button>
                      <template v-if="scope.row.state == 2">
                        <el-button size="mini" type="warning" plain icon="el-icon-close" @click="editSysAttractionOrder(scope.row.id,4)">拒绝取消</el-button>
                        <el-button size="mini" type="primary" plain icon="el-icon-check" @click="editSysAttractionOrder(scope.row.id,3)">允许取消</el-button>
                      </template>
                      <el-button size="mini" type="primary" plain icon="el-icon-check" v-if="scope.row.state == 0" @click="editSysAttractionOrder(scope.row.id,1)">确认</el-button>
